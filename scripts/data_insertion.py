...
def main():
    database = r"recruitment-automation\data\recruitment.db"  # Path to your database file
    csv_file = r"recruitment-automation\data\job_description.csv"  # Path to your CSV file
