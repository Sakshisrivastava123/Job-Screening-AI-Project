...
def create_connection():
    ...
    database = r"C:\Users\lenovo\Desktop\recruitment-automation\data\recruitment.db"
...
def main():
    database = r"recruitment-automation\data\recruitment.db"
    ...
    conn = create_connection()
    csv_file = r"recruitment-automation\data\job_description.csv"
