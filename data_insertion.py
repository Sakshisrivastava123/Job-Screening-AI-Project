...
def main():
    database = r"C:\Users\lenovo\Desktop\recruitment-automation\data\recruitment.db"  # Path to your database file
    csv_file = r"C:\Users\lenovo\Desktop\recruitment-automation\data\job_description.csv"  # Path to your CSV file
